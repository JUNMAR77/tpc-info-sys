...
class Course2021TableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $course->description = 'Computer Programming II';
        $course->units = 3;
        $course->lab_units = 1;
        $course->save();

        $course = new Course;
        $course->course_code = 'CC 103';
