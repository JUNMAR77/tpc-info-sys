                      ...
                      <form id="form-post" method="POST" action="{{ action('App\Http\Controllers\CreditedCoursesDetailsController@update', [$user->id, $school->credit_id, $course->credit_details_id]) }}">
                            ...
                            <div class="col-12 col-lg-4 col-md-6">
                              ...
                              <select id="acad_term_id" name="acad_term_id" class="select2 form-control m-b" required>
                                @foreach ($acad_terms as $acad_term)
                                  @if($course->acad_term_id == $acad_term->acad_term_id)
                          ...
                          <div class="row mt-4">
                            <div class="col-12 col-lg-3 col-md-6">
                                ...
                                <input id="course_code" name="course_code" class="form-control mb-3" type="text" placeholder="e.g. CSC100" value="{{ $course->course_code }}" required>
                            </div>
                          </div>
                          ...
                          <div class="row mt-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input id="description" name="description" class="form-control mb-3" type="text" placeholder="e.g. Programming Fundamentals I" value="{{ $course->description }}" required>
                            </div>
                          </div>
                          ...
                          <div class="row mt-3">
                            <div class="col-12 col-lg-2 col-md-6">
                                ...
                                <input id="units" name="units" class="form-control mb-3" type="text" placeholder="e.g. 3" value="{{ $course->units }}" required>
                            </div>
                          </div>
                          ...
                          <div class="row mt-3">
                            <div class="col-12 col-lg-2 col-md-6">
                                ...
                                <input id="grade" name="grade" class="form-control mb-3" type="text" placeholder="e.g. 1.25" value="{{ $course->grade }}" required>
                            </div>
                            <div class="col-12 col-lg-2 col-md-6">
                              <div class="form-control-label mb-3">Is INC?</div>
                              <label class="custom-toggle">
                                <input name="is_inc" type="checkbox" {{ $course->is_inc ? 'checked' : '' }}>
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <select name="curriculum_details_id" class="select2 form-control m-b" required>
                                @foreach ($user->student->curriculum->curriculumDetails as $curriculum_details)
                                  @if($course->curriculum_details_id == $curriculum_details->curriculum_details_id)
                          ...
                          <div class="row mt-5">
                              <div class="col-12 col-lg-12">
                                <button type="submit" class="btn btn-outline-info">
                                  ...
                                  <span class="btn-inner--text">Update Credited Course</span>
                                </button>
