                        ...
                        <form id="form-post" method="POST" action="{{ action('App\Http\Controllers\StudentController@store') }}" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                <div class="form-group{{ $errors->has('student_no') ? ' has-danger' : '' }} col-lg-4">
                                    ...
                                    <input type="text" name="student_no" id="student_no" class="input-mask form-control form-control-alternative{{ $errors->has('student_no') ? ' is-invalid' : '' }}" placeholder="e.g. 04-17-30001" value="{{ old('student_no') }}" data-mask="00-00-00000"  data-mask-clearifnotmatch="true" required autofocus>
                            ...
                            <div class="pl-lg-4 row mt-4">
                              <div class="form-group col row">
                                ...
                                <div class="ml-3 custom-control custom-radio mb-3">
                                  <input name="student_type" class="custom-control-input" id="student_type1" type="radio" value="Regular" {{ old('student_type') == null ? 'checked' : '' }}>
                                  <label class="custom-control-label" for="student_type1">Regular</label>
                                </div>
                                <div class="ml-3 custom-control custom-radio mb-3">
                                  <input name="student_type" class="custom-control-input" id="student_type2" type="radio" value="Transferee" {{ old('student_type') == 'Transferee' ? 'checked' : '' }}>
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="form-group{{ $errors->has('primary_sy') ? ' has-danger' : '' }} col col-md-4">
                                    ...
                                    <input type="text" name="primary_sy" id="primary_sy" class="form-control form-control-alternative{{ $errors->has('primary_sy') ? ' is-invalid' : '' }}" placeholder="e.g. 2000-2004" value="{{ old('primary_sy') }}" data-mask="0000-0000"  data-mask-clearifnotmatch="true" required>
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="form-group{{ $errors->has('intermediate_sy') ? ' has-danger' : '' }} col col-md-4">
                                    ...
                                    <input type="text" name="intermediate_sy" id="intermediate_sy" class="form-control form-control-alternative{{ $errors->has('intermediate_sy') ? ' is-invalid' : '' }}" placeholder="e.g. 2004-2006" value="{{ old('intermediate_sy') }}" data-mask="0000-0000"  data-mask-clearifnotmatch="true" required>
                            ...
                            <div class="pl-lg-4 row">
                                <div class="form-group{{ $errors->has('secondary') ? ' has-danger' : '' }} col col-md-8">
                                    ...
                                    <input type="text" name="secondary" id="secondary" class="form-control form-control-alternative{{ $errors->has('secondary') ? ' is-invalid' : '' }}" placeholder="e.g. Lakandula High School" value="{{ old('secondary') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('secondary_sy') ? ' has-danger' : '' }} col col-md-4">
                                    ...
                                    <input type="text" name="secondary_sy" id="secondary_sy" class="form-control form-control-alternative{{ $errors->has('secondary_sy') ? ' is-invalid' : '' }}" placeholder="e.g. 2006-2010" value="{{ old('secondary_sy') }}" data-mask="0000-0000"  data-mask-clearifnotmatch="true" required>
