                      ...
                      <form id="form-post" method="POST" action="{{ action('App\Http\Controllers\CourseController@store') }}">
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-3 col-md-6">
                                ...
                                <input id="course_code" name="course_code" class="form-control mb-3" type="text" placeholder="e.g. IT121" required>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-3 col-md-6">
                                ...
                                <input id="units" name="units" class="form-control mb-3" type="number" placeholder="e.g. 3" min="1" required>
                            </div>
                            <div class="col-12 col-lg-3 col-md-6">
                              <label class="form-control-label" for="lab_units">Lab Units (optional)</label>
                              <input id="lab_units" name="lab_units" class="form-control mb-3" type="number" min="1" placeholder="e.g. 3">
