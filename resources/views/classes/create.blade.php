...
@section('content')
    @include('layouts.headers.header', ['title' => 'Add Class'])
                        ...
                        <form id="form-post" method="POST" action="{{ action('App\Http\Controllers\SClassController@store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4 row mt-3">
                              <div class="form-group{{ $errors->has('section') ? ' has-danger' : '' }} col-12 col-lg-4 col-md-6">
                                  ...
                                  <input type="text" name="section" id="section" class="form-control form-control-alternative{{ $errors->has('section') ? ' is-invalid' : '' }}" placeholder="e.g. 101-A" value="{{ old('section') }}">
                              ...
                              <div class="form-group{{ $errors->has('room') ? ' has-danger' : '' }} col-12 col-lg-4 col-md-6">
                                  ...
                                  <input type="text" name="room" id="room" class="form-control form-control-alternative{{ $errors->has('room') ? ' is-invalid' : '' }}" placeholder="e.g. College Room" value="{{ old('room') }}">
                                  ...
                                  <div class="row">
                                      <div class="col-12 col-md-6">
                                        ...
                                        <select id="lec_day" name="lec_day" class="form-control form-control-alternative m-b" required>
                                          <option value="M" {{ old('lec_day') == null || old('lec_day') == 'M' ? 'selected' : '' }}>Monday</option>
                                          <option value="T" {{  old('lec_day') == 'T' ? 'selected' : '' }}>Tuesday</option>
                                          <option value="W" {{  old('lec_day') == 'W' ? 'selected' : '' }}>Wednesday</option>
                                          <option value="TH" {{  old('lec_day') == 'TH' ? 'selected' : '' }}>Thursday</option>
                                          <option value="F" {{  old('lec_day') == 'F' ? 'selected' : '' }}>Friday</option>
                                        </select>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="form-group{{ $errors->has('lec_time_start') ? ' has-danger' : '' }} col-12 col-md-6 mt-3">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="time" name="lec_time_start" id="lec_time_start" class="form-control form-control{{ $errors->has('lec_time_start') ? ' is-invalid' : '' }}" value="{{ old('lec_time_start') }}" required>
                                        </div>
                                    ...
                                    <div class="form-group{{ $errors->has('lec_time_end') ? ' has-danger' : '' }} col-12 col-md-6 mt-3">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="time" name="lec_time_end" id="lec_time_end" class="form-control form-control{{ $errors->has('lec_time_end') ? ' is-invalid' : '' }}" placeholder="Time End" value="{{ old('lec_time_end') }}" required>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                      ...
                                      <select id="lab_day" name="lab_day" class="form-control form-control-alternative m-b">
                                        ...
                                        <option value="M" {{  old('lab_day') == 'M' ? 'selected' : '' }}>Monday</option>
                                        <option value="T" {{  old('lab_day') == 'T' ? 'selected' : '' }}>Tuesday</option>
                                        <option value="W" {{  old('lab_day') == 'W' ? 'selected' : '' }}>Wednesday</option>
                                        <option value="TH" {{  old('lab_day') == 'TH' ? 'selected' : '' }}>Thursday</option>
                                        <option value="F" {{  old('lab_day') == 'F' ? 'selected' : '' }}>Friday</option>
                                      </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="form-group{{ $errors->has('lab_time_start') ? ' has-danger' : '' }} col-12 col-md-6 mt-3">
                                      ...
                                      <div class="input-group ">
                                          ...
                                          <input type="time" name="lab_time_start" id="lab_time_start" class="form-control form-control{{ $errors->has('lab_time_start') ? ' is-invalid' : '' }}" placeholder="Time Start" value="{{ old('lab_time_start') }}">
                                      </div>
                                  ...
                                  <div class="form-group{{ $errors->has('lab_time_end') ? ' has-danger' : '' }} col-12 col-md-6 mt-3">
                                      ...
                                      <div class="input-group ">
                                          ...
                                          <input type="time" name="lab_time_end" id="lab_time_end" class="form-control form-control{{ $errors->has('lab_time_end') ? ' is-invalid' : '' }}" placeholder="Time End" value="{{ old('lab_time_end') }}">
                                      </div>
